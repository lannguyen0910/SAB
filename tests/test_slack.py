...
class TestSlack:
    ...
    def test_format_article_block_returns_expected(self):
        ...
        utc_dt = datetime.datetime(2021, 3, 1, 1, 1, 1).replace(
            tzinfo=pytz.utc)
        expected_dt = "2021-03-01 08:01:01"
        expected = {
            "type": "section",
            "text": {
                "type": "mrkdwn",
        ...
        expected = [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"{news_facade.SLACK_BOT_TEXT}"
                }
            }
        ]
    ...
    def test_create_rich_message_layout_returns_expected(self):
        ...
        assert self.client.create_rich_message_layout(
            name, input_obj) == expected
    ...
    def test_create_rich_message_layout_returns_expected_continued(self):
        ...
        assert self.client.create_rich_message_layout(
            name, input_obj, cont=True) == expected
